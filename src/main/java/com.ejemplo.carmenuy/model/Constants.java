//CarmenSandiegoUruguay/src/main/java/com.ejemplo.carmenuy/model/Constants.java
...
public final class Constants {
    ...
    public static final int NUMERO_LOCALIDADES = 40;
    public static final int NUMERO_PISTAS = 20;
}
